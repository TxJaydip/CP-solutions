...
int main()
{
    ...
    while (t--)
    {
        ...
        if (s.length() == 3 && s[1] == '0')
        {
            ...
            {
                cout << min(stoi(s.substr(0, 1)) * stoi(s.substr(2, 1)),
                            stoi(s.substr(0, 1)) + stoi(s.substr(2, 1)))
                     << endl;
            }
            continue;
        }
        ...
        int maxi = 0;
        if (s.substr(0, 2) != "01")
            maxi = stoi(s.substr(0, 2));
        for (int i = 2; i < n; i++)
        {
            if (s[i] != '1')
            {
                maxi += stoi(s.substr(i, 1));
            }
        }
