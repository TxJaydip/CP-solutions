...
int findMinimumTime(vector<int> &v, int K)
{
    ...
    do
    {
        ...
        while (true)
        {
            ...
            int current = currentV[ind];
            // cout << "ind: " << ind << ", curr: " << current << endl;
            if (s < current)
            {
                long long req = ceil((long double)(current - s) / (long double)k);
                ans += req;
                k += K;
                ind++;
                s = k;
