...
int fun(string s1, string s2, int i1, int i2, vector<vector<int>> &dp)
{
    ...
    {
        dp[i1][i2] = abs(((int)s1.length() - i1) - ((int)s2.length() - i2));
        return abs(((int)s1.length() - i1) - ((int)s2.length() - i2));
    }
    int ans = 0;
    if (s1[i1] == s2[i2])
    {
        ans = fun(s1, s2, i1 + 1, i2 + 1, dp);
        dp[i1][i2] = ans;
        return ans;
    }
    ans = min({1 + fun(s1, s2, i1 + 1, i2 + 1, dp),
               1 + fun(s1, s2, i1 + 1, i2, dp),
               1 + fun(s1, s2, i1, i2 + 1, dp)});
    dp[i1][i2] = ans;
    return ans;
}
