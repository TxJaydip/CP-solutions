...
void solve()
{
    ...
    {
        ll curr_sum = sum - v[i];
        ll minReq = curr_sum - y;
        ll maxReq = curr_sum - x;

        // cout << "i: " << i << ", CurrSum: " << curr_sum << endl;
        // cout << "MinReq: " << minReq << ", MaxReq: " << maxReq << endl;
        // if (minReq <= 0)
        // {
        //     cout << "\n";
        //     continue;
        ...
        auto it1 = lower_bound(stIt, v.end(), minReq);
        auto it2 = upper_bound(stIt, v.end(), maxReq);
        ...
        ll minIndex = it1 - v.begin();
        ll maxIndex = it2 - v.begin();
        ...
        if (minIndex <= maxIndex)
        {
            ...
            if (v[i] >= minReq && v[i] <= maxReq)
            {
                ans--;
            }
        }

        // cout << "MinFound: " << minFound << ", MaxFound: " << maxFound << endl;
        // cout << "MinIndex: " << minIndex << ", MaxIndex: " << maxIndex << "\t ans: " << ans << endl;
        // cout << "\n";
        stIt++;
    }
    cout << ans << endl;
