...
int main()
{
    ...
    while (t--)
    {
        ...
        mp.clear();
        ll curr_mex = 0;
        // cout << "v0: " << v[0] << ", v1: " << v[1] << ", v2: " << v[2] << endl;
        for (int i = 0; i < n; i++)
        {
            if (v[i] < mex && mp[v[i]] == 0)
            {
            ...
            // cout << "i: " << i << ", vi: " << v[i] << ", mp0: " << mp[0] << ", mp1: " << mp[1] << ", mp2: " << mp[2] << endl;
            if (curr_mex == mex)
            {
                pair<int, int> temp;
                temp.first = prev + 1;
                temp.second = i + 1;
                // cout << "1: " << temp.first << ", 2: " << temp.second << endl;
                // cout << "prev: " << prev << ", prev(updated): " << i + 1 << endl;
                prev = i + 1;
                mp.clear();
                curr_mex = 0;
                ans.pb(temp);
            ...
            {
                // cout << "in if" << endl;
                ans[ans.size() - 1].second = i + 1;
            }
        }
        if (ans[ans.size() - 1].second != n || ans.size() == 1)
        {
            cout << -1 << endl;
        }
        else
