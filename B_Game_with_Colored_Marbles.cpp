...
void solve()
{
    ...
    // print(mp);
    ll ans = 2 * ceil((long double)(cnt1) / (long double)(2.0));
    ll ans2 = 0;
    for (auto i : mp)
    {
        if (i.second != 1)
    ...
    //     return;
    // }
    // cout << ans + ceil((long double)(cntOther) / (long double)(allCnt)) << endl;
    // cout << "ans: " << ans << ", ceil Cnt1: " << ceil((long double)(cnt1) / (long double)(2.0)) << ", ceil cntother: " << ceil((long double)(cntOther) / (long double)(2.0)) << endl;
}
// -----------------------------------------------------------------------------------
int main()
{
