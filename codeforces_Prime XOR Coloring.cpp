...
vector<bool> primes(200001, 1);
// vector<vector<int>> ans;
vector<map<int, int>> ans1;
vector<int> temp;
...
void fun1(int n)
{
    ...
    for (int i = 2; i <= n; i++)
    {
        ...
        // temp = ans.back();
        auto it11 = ans1[connections[i][0]].end();
        it11--;
        int temp1 = 1 + (*it11).first;
        // int temp1 = 1 + (ans[connections[i][0]][ans[connections[i][0]].size() - 1]);
        // temp.pb(temp[temp.size() - 1] + 1);
        // temp.pb(temp1);
        // ans.pb(temp);
...
int main()
{
    ...
    for (auto nn : v1)
    {
        ...
        for (auto pairr : mapp)
        {
            int tmp12 = pairr.first;
            for (int i = 0; i < pairr.second; i++)
            {
                cout << tmp12 << " ";
            }
        }
