...
ll modex1(ll a, ll b);
ll mod(ll a, ll b);
vi sieve_of_eratosthenes(ll limit);
// -----------------------------------------------------------------------------------

vi divi(101, 0);

vi isPrime(1000001, 1);

vi primes = sieve_of_eratosthenes(100);
vi divisors(100 + 1, 1);

map<ll, ll> primef(ll n)
{
    map<ll, ll> ans;
    for (int i = 2; i * i <= n; i++)
    {
...
// ll noOfDivisorsOfFactorial(ll n)
// {
//     ll ans = 1;
...
void solve()
{
    ...
    // {
    //     ll fact = factorial(i);
    //     cout << i << ": " << " -> " << divisors(fact) << endl;
    // }

    // print(divi);
    // cout << noOfDivisorsOfFactorial(4) << endl;
    // cout << noOfDivisorsOfFactorial(6) << endl;
}
// -----------------------------------------------------------------------------------

//  divisors of 720 : 1, 2, 3, 4, 5, 6, 8, 9, 10, 12, 15, 16, 18, 20, 24, 30, 36, 40, 45, 48, 60, 72, 80, 90, 120, 144, 180, 240, 360, 720
